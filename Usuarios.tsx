...
const DEFAULT_PERMISSOES: Record<string, string[]> = {
  admin: ['dashboard', 'dashboard_vendas', 'kanban', 'vendas', 'calendario_vendas', 'registro', 'agenda',
    ...
    'relatorio_downtime_tecnico', 'relatorio_downtime_maquina', 'analise_gargalos', 'relatorio_boletim_pro',
  ...
  lider: ['dashboard', 'registro', 'agenda', 'relatorio_registros', 'analise_disponibilidade',
    ...
    'relatorios_downtime_horas', 'relatorio_downtime_tecnico', 'relatorio_downtime_maquina', 'analise_gargalos',
...
const Usuarios: React.FC<UsuariosProps> = ({ onPermissionsChange }) => {
  ...
  const ALL_SCREENS: { id: string; label: string; group: string }[] = [
    ...
    { id: 'relatorio_downtime_maquina', label: 'Downtime por Máquina', group: 'Relatórios' },
    { id: 'analise_gargalos', label: 'Gargalos', group: 'Relatórios' },
    { id: 'relatorio_boletim_pro', label: 'Boletim Pro', group: 'Relatórios IA' },
    { id: 'relatorio_consumo_agua', label: 'Consumo de Água', group: 'Relatórios IA' },
    { id: 'relatorio_consumo_agua_sku', label: 'Boletim por SKU', group: 'Relatórios IA' },
    { id: 'dados_poco', label: 'Dados do Poço', group: 'Relatórios IA' },
