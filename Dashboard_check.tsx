        ...
        <div className="flex items-center gap-4 w-full md:w-auto">
          ...
          <div className="flex items-center gap-3 bg-white/10 px-4 py-2 rounded-xl border border-white/5 focus-within:border-[#facc15] transition-all shadow-sm">
            ...
            <input
              ...
              className="bg-transparent text-xs font-black outline-none uppercase text-white cursor-pointer hover:text-[#facc15] transition-colors"
            />
          </div>
        ...
        < div className="space-y-6" >
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
            {lineMonitor.map(line => (
              <div key={line.id} className={`bg-[#141414] border p-8 rounded-[32px] group transition-all duration-500 shadow-xl relative overflow-hidden ${line.alertSeverity === 'CRITICAL' ? 'border-rose-500 shadow-[0_0_30px_rgba(244,63,94,0.15)] animate-pulse' :
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8">
                  <div className="flex items-center gap-6">
                    <div className={`p-5 rounded-2xl ${line.alertSeverity === 'CRITICAL' ? 'bg-rose-500/20 text-rose-500' :
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        <div className={`w-2 h-2 rounded-full ${line.alertSeverity === 'CRITICAL' ? 'bg-rose-500 shadow-[0_0_10px_#f43f5e]' :
                        ...
                        <span className={`text-[10px] font-black uppercase tracking-[0.2em] ${line.alertSeverity === 'CRITICAL' ? 'text-rose-500' :
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center px-1">
                    <div className="flex flex-col min-w-0 flex-1">
                      <p className={`text-[11px] font-black uppercase tracking-[0.2em] flex items-center gap-2 truncate ${line.alertSeverity === 'CRITICAL' ? 'text-rose-400' : 'text-[#facc15]'
                        }`}>
                        <Package className="w-3 h-3 shrink-0" /> {line.produto}
                      </p>
                      {line.alertSeverity !== 'NONE' && (
                        <p className={`text-[9px] font-bold uppercase mt-1 italic truncate ${line.alertSeverity === 'CRITICAL' ? 'text-rose-500' : 'text-amber-500'
                          }`}>
                  ...
                  <div className="h-2.5 w-full bg-white/5 rounded-full overflow-hidden border border-white/5">
                    <div className={`h-full transition-all duration-1000 ease-out ${line.alertSeverity === 'CRITICAL' ? 'bg-rose-500 shadow-[0_0_15px_#ef4444]' :
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {metasSemanais.length > 0 ? metasSemanais.map((meta) => (
              <div key={meta.id} className="bg-black/40 border border-white/5 p-6 rounded-3xl hover:border-white/10 transition-all group relative overflow-hidden">
                ...
                <div className={`absolute top-0 left-0 w-full h-1 ${meta.status === 'CONCLUÍDO' ? 'bg-[#22c55e] shadow-[0_0_10px_#22c55e]' :
                ...
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className={`px-3 py-1 rounded-full text-[8px] font-black border uppercase tracking-widest flex items-center gap-1.5 ${meta.status === 'CONCLUÍDO' ? 'bg-[#22c55e]/10 text-[#22c55e] border-[#22c55e]/20' :
                ...
                <div className="flex justify-between items-end mb-4">
                  ...
                  <span className={`text-lg font-black tracking-tighter ${meta.status === 'CONCLUÍDO' ? 'text-[#22c55e]' :
                ...
                <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                  <div className={`h-full transition-all duration-1000 ${meta.status === 'CONCLUÍDO' ? 'bg-[#22c55e]' :
              ...
              <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                ...
                <div className="bg-[#1a1a1a] rounded-[40px] shadow-2xl w-full max-w-2xl relative z-10 border border-white/10 overflow-hidden animate-in zoom-in-95 duration-500">
                  <header className="px-10 py-10 border-b border-white/5 flex items-center justify-between">
                    <div className="flex items-center gap-6">
                      <div className={`p-4 rounded-2xl ${modalLinha.alertSeverity === 'CRITICAL' ? 'bg-rose-500 shadow-[0_0_20px_rgba(244,63,94,0.4)]' :
