          ...
          <div className="bg-[#141414] rounded-[40px] shadow-2xl w-full max-w-2xl relative z-10 border border-[#facc15]/20 overflow-hidden animate-in zoom-in-95">
            <header className="px-10 py-10 border-b border-white/5 flex items-center justify-between">
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h3 className="text-3xl font-black text-white uppercase tracking-tighter leading-none">Novo Pedido</h3>
                  <p className="text-slate-500 text-[10px] font-bold uppercase tracking-widest mt-2 flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#facc15]" /> Entrada de Demanda Industrial
                  </p>
                </div>
              </div>
               ...
               {(() => {
                 ...
                 return (
                   <button 
                    ...
                    className={`flex-[2] py-5 rounded-3xl text-[10px] font-black uppercase tracking-[0.4em] transition-all ${
                      todosProntos && selectedPedido.status !== 'Finalizado'
