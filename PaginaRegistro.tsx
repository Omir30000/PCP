...
const MOTIVOS_COMUNS: Record<string, string[]> = {
  ...
  'PARADA PROGRAMADA': ['INTERVALO REFEIÇÃO', 'INVENTÁRIO', 'DESCANSO', 'HORA DO CAFÉ'],
  'OPERACIONAL': ['INÍCIO DE TURNO', 'FALTA DE OPERADOR', 'TROCA DE RÓTULO', 'AJUSTE DE PROCESSO', 'FALTA DE RÓTULO', 'FALTA DE COLA', 'TROCA DE BOBINA', 'LIMPEZA DE COLA', 'AGUARDANDO LIBERAÇÃO DO LABORATÓRIO'],
