...
const EnvioDeRegistros: React.FC = () => {
        ...
        try {
            ...
            if (data && data.length > 0) {
                const enrichedData: RegistroExpandido[] = data.map((reg: RegistroProducao) => {
                    // Formatação manual da data ISO (YYYY-MM-DD) para evitar fuso horário
                    const [year, month, day] = reg.data_registro.split('-');
                    ...
                    return {
                        ...
                        data_exibicao: dataExibicao // Campo auxiliar para exibição
                    };
                });
...
export default EnvioDeRegistros;
